...
from pybulletgym.envs.mujoco.robot_pendula import InvertedPendulum, InvertedPendulumSwingup, InvertedDoublePendulum
import numpy as np
...
class InvertedPendulumSwingupBulletEnv(InvertedPendulumMuJoCoEnv):
	def __init__(self):
